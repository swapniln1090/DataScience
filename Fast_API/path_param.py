...
# So remember this has a sequential execution. Hence if you want to allow a specific endpoint first before dynamic endpoint.
...
async def get_food(food_name: FoodSelect):
    ...
    if food_name in FoodSelect.cold_drinks:
        return {
            "message": f"You are Cold Drink Lover and You have selected {food_name}. This is not Healthy"
        }
